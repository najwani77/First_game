  ...
  return (
    <div className="mx-auto max-w-xl p-5">
      <header className="py-10">
        <h1 className="text-3xl font-extrabold">لعبة البوصلة الأخلاقية</h1>
        <p className="mt-2 opacity-90">نموذج تجريبي بحلقة واحدة لإظهار الفكرة.</p>
      </header>

      <div className="grid gap-4">
        <Link href="/episode/ep1" className="block rounded-2xl border border-slate-800 p-4 hover:bg-slate-900">
